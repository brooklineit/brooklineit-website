        ...
        <div className="wrap">
          ...
          <div className={styles.svcGrid}>
            {[
              ...
              { num: '05', href: '/marketing', title: 'Marketing', desc: 'Google Ads, local SEO, and websites built to turn visitors into calls. Restoration is our deepest specialty — including storm-triggered ad automation we built ourselves.' },
